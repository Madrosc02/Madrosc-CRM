...
const MOCK_CUSTOMERS: Customer[] = [
  { id: '1', name: 'Rohan Sharma', firmName: 'Rohan Enterprises', personName: 'Rohan Sharma', monopolyStatus: 'Non-Monopoly', contact: '9876543210', alternateContact: '8877665544', avatar: `https://i.pravatar.cc/150?u=1`, tier: 'Gold', state: 'Maharashtra', district: 'Mumbai', salesThisMonth: 15000, avg6MoSales: 25000, outstandingBalance: 5000, daysSinceLastOrder: 10, lastUpdated: new Date(Date.now() - 2 * 24 * 3600 * 1000).toISOString() },
  { id: '2', name: 'Priya Patel', firmName: 'Patel Tradings', personName: 'Priya Patel', monopolyStatus: 'Monopoly', contact: '9876543211', avatar: `https://i.pravatar.cc/150?u=2`, tier: 'Silver', state: 'Gujarat', district: 'Ahmedabad', salesThisMonth: 8000, avg6MoSales: 12000, outstandingBalance: 1200, daysSinceLastOrder: 25, lastUpdated: new Date(Date.now() - 5 * 24 * 3600 * 1000).toISOString() },
  { id: '3', name: 'Amit Singh', firmName: 'Singh Corp', personName: 'Amit Singh', monopolyStatus: 'Non-Monopoly', contact: '9876543212', avatar: `https://i.pravatar.cc/150?u=3`, tier: 'Bronze', state: 'Uttar Pradesh', district: 'Lucknow', salesThisMonth: 0, avg6MoSales: 5000, outstandingBalance: 8000, daysSinceLastOrder: 45, lastUpdated: new Date(Date.now() - 10 * 24 * 3600 * 1000).toISOString() },
  { id: '4', name: 'Sunita Rao', firmName: 'Rao Distributors', personName: 'Sunita Rao', monopolyStatus: 'Monopoly', contact: '9876543213', alternateContact: '7766554433', avatar: `https://i.pravatar.cc/150?u=4`, tier: 'Gold', state: 'Karnataka', district: 'Bengaluru Urban', salesThisMonth: 30000, avg6MoSales: 45000, outstandingBalance: 0, daysSinceLastOrder: 5, lastUpdated: new Date(Date.now() - 1 * 24 * 3600 * 1000).toISOString() },
  { id: '5', name: 'Vikram Reddy', firmName: 'Reddy Agencies', personName: 'Vikram Reddy', monopolyStatus: 'Non-Monopoly', contact: '9876543214', avatar: `https://i.pravatar.cc/150?u=5`, tier: 'Silver', state: 'Telangana', district: 'Hyderabad', salesThisMonth: 12000, avg6MoSales: 10000, outstandingBalance: 3000, daysSinceLastOrder: 15, lastUpdated: new Date(Date.now() - 3 * 24 * 3600 * 1000).toISOString() },
  { id: '6', name: 'Anjali Gupta', firmName: 'Gupta Traders', personName: 'Anjali Gupta', monopolyStatus: 'Non-Monopoly', contact: '9876543215', avatar: `https://i.pravatar.cc/150?u=6`, tier: 'Dead', state: 'Delhi', district: 'New Delhi', salesThisMonth: 0, avg6MoSales: 2000, outstandingBalance: 500, daysSinceLastOrder: 120, lastUpdated: new Date(Date.now() - 90 * 24 * 3600 * 1000).toISOString() },
];
