...
const TerritoryHeatmap: React.FC = () => {
    ...
    const stateData = useMemo(() => {
        ...
        const data: Record<string, { sales: number; customerCount: number }> = {};
        ...
        customers.forEach(customer => {
            ...
            if (!data[normalizedState]) {
                data[normalizedState] = { sales: 0, customerCount: 0 };
            }
                        ...
                        <Geographies geography={INDIA_TOPO_JSON}>
                            {({ geographies }) =>
                                geographies.map((geo) => {
                                    ...
                                    const cur = stateData[stateName] || stateData[stateName.toUpperCase()] || { sales: 0, customerCount: 0 };
