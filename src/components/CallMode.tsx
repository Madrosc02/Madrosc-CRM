...
const CallMode: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F4F7FB] text-[#111827] pb-24 relative overflow-hidden font-sans">
            ...
            {/* --- Main Content Area --- */}
            <div className={`container mx-auto px-4 pt-24 pb-28 transition-all duration-500 ease-in-out ${isAnimating ? 'opacity-0 translate-x-8' : 'opacity-100 translate-x-0'}`}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-[calc(100vh-340px)] min-h-[500px]">
