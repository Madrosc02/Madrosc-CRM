                ...
                <div className="fixed bottom-0 left-0 right-0 p-3 bg-white/90 backdrop-blur-xl border-t border-[#E1E7F0] z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.1)]">
                    <div className="container mx-auto flex justify-between items-center max-w-6xl">
                        <button
                            ...
                            className="px-5 py-2 rounded-lg font-semibold text-[#6B7280] hover:bg-slate-100 disabled:opacity-30 transition-all flex items-center gap-2"
                        >
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className="px-6 py-2 rounded-lg font-bold bg-[#00B894] text-white shadow-lg shadow-[#00B894]/30 hover:bg-[#008C6E] hover:scale-105 transition-all flex items-center gap-2"
                            >
